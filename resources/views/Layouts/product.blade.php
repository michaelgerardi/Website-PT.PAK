...
<body>
    ...
    <section>
        <div class="border_product">
            <h2>Product</h2>
           <div class="garis_produk"></div>
            <div class="garis_product">
                <div class="kotak_product">   
                     <div class="kotak_nama">
                        <h3>Terpentine Oil</h3>
                     </div>
                </div>
                <div class="kotak_product_1">   
                    <div class="kotak_nama_1">
                       <h3>Rosepak A-100</h3>
                    </div>
               </div>
               <div class="kotak_product_2">   
                <div class="kotak_nama_2">
                   <h3>Rosepak C-130</h3>
                </div>
           </div>
           </div>
