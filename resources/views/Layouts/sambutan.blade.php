...
<body>
    ...
    <!-- sambutan -->
    <section>
        <div class="boder_sambutan">
            <h2>Sambutan Direktur Utama</h2>
            <div class="garis_sambutan"></div>
            <div class="sambutan">
                <div class="foto">
                    <p>PT Perhutani Anugerah Kimia (PAK) adalah salah satu anak perusahaan Perum Perhutani, didirikan pada tahun 2002. Kami berkonsentrasi di bidang pengolahan getah pinus menjadi derivate gum rosin dan terpentin.
                        Kami berusaha untuk memuaskan klien-klien kami dengan budaya kerja yang professional. Dengan kreatifitas dan inovasi yang terus menerus, kami berusaha menghasilkan produk yang unggul dan kompetitif. Kami juga secara kontinyu terus mengembangkan produk-produk kami dengan didukung oleh Tim R & D yang handal dan bekerjasama dengan PerguruanTinggi,  agar dapat mengikuti perkembangan teknologi yang terus berkembang.
                        Kami segenap direksi, staff dan karyawan PT PAK mengucapkan terimakasih kepada seluruh mitra kerja, rekan bisnis dan klien atas kepercayaan yang telah diberikan kepada kami.
                        Kepada calon mitra kerja baru, kami menyambut baik kerjasama bersama anda, semoga kita dapat menjalin kemitraan yang baik dan saling menguntungkan di masa mendatang.</p>
                    <h4> Ir. Gunawan Marga Widada</h4>
                    </div>
            </div>
        </div>
    </section>
