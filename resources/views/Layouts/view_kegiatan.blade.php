...
<body>
    ...
    <ul class="breadcrumbs">
        ...
        <li class="breadcrumbs__item">
            <a href="#" class="breadcrumb__link breadcrumb__link-active">Kegiatan</a>
        </li>
        <li class="breadcrumbs__item">HTML5 & CSS3</li>
    </ul>
    <!-- breadcrumb -->
    <section>
        @foreach ($view_kegiatan as $kegiatan)
        <div class="link_berita">
            <h1>test satu</h1>
                <ul class="admin_berita">
                    ...
                    <li class="admin-berita-item">
                        <a href="">{{$kegiatan->created_at->format('d/m/y')}}</a>
                    </li>
                    <li class="admin-berita-item">
        ...
        <div class="arkitel_kegiatan">
            <p>{{$kegiatan->isi_kegiatan}}</p>
            <p>Tanggal Pelaksanaan : {{$kegiatan->tanggal_kegiatan}}</p>
            <p>jam Pelaksanaan : {{$kegiatan->jam_kegiatan}} </p>
        </div>
        @endforeach
    </section>
    <!-- footer -->
    <div class="footer">
        <div class="footer-content">
            ...
            <div class="footer-section Product">
                ...
                <br>
                    <ul>
                        <a href="#"><li>Rosepak A-095</li></a>
                        <a href="#"><li>Rosepak A-100</li></a>
                        <a href="#"><li>Rosepak C-130</li></a>
                        <a href="#"><li>Gumrosin & Terpentine oil</li></a>
                        <a href="#"><li>Ester Rosin</li></a>
                    </ul>
            </div>
